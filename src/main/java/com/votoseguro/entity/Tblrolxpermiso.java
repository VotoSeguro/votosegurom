...
public class Tblrolxpermiso implements Serializable {
    ...
    @GeneratedValue (strategy = GenerationType.SEQUENCE, generator = "ROLXPERMISO_SQE")
    @SequenceGenerator(name = "ROLXPERMISO_SQE", sequenceName = "SQE_ROLXPERMISO", allocationSize = 1)
